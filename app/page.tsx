...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-950 dark:to-gray-900">
      ...
      {/* Testimonial Section */}
      <section className="py-24 md:py-32 bg-gray-50 dark:bg-gray-900 relative">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-purple-100/30 to-transparent dark:from-purple-900/10 z-0" />
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white dark:bg-gray-800 p-8 md:p-12 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-700">
              <div className="flex items-center gap-5 mb-8">
                <div className="w-16 h-16 bg-purple-100 dark:bg-purple-900/30 rounded-full flex-shrink-0"></div>
                <div>
                  <h4 className="text-xl font-bold text-gray-900 dark:text-white">Sarah Johnson</h4>
                  <p className="text-gray-600 dark:text-gray-400">CEO, InnovateX Solutions</p>
                </div>
              </div>
              <blockquote className="text-xl md:text-2xl italic text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
                "ARPK transformed our digital presence completely. Their attention to detail and strategic approach resulted in a 40% increase in qualified leads within three months of launch."
              </blockquote>
              <div className="flex items-center">
                ...
                <span className="text-gray-500 dark:text-gray-400 ml-2 text-sm">5.0 rating</span>
              </div>
            </div>
          </div>
        </div>
